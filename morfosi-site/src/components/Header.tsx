        ...
        >
          <div className="w-full px-4 md:px-6 xl:px-2 min-[1400px]:px-4 2xl:px-8 flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              {/* Desktop Nav */}
              <nav
                className="hidden min-[1380px]:flex items-center min-[1380px]:gap-0 2xl:gap-4"
                ...
                {dynamicNavItems.map((item) => (
                  ...
                  >
                    {item.href && !item.children ? (
                      <Link
                        href={item.href}
                        className="flex items-center gap-1 min-[1380px]:px-1.5 2xl:px-3 py-5 font-black min-[1380px]:text-[10px] min-[1450px]:text-[11px] 2xl:text-[13px] uppercase min-[1380px]:tracking-tight min-[1450px]:tracking-normal 2xl:tracking-widest text-gray-800 hover:text-brand-teal transition-colors relative group whitespace-nowrap"
                      >
                        {item.label}
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1 min-[1380px]:px-1.5 2xl:px-3 py-5 font-black min-[1380px]:text-[10px] min-[1450px]:text-[11px] 2xl:text-[13px] uppercase min-[1380px]:tracking-tight min-[1450px]:tracking-normal 2xl:tracking-widest transition-colors relative group cursor-pointer whitespace-nowrap ${openMenu === item.id
                            ? "text-brand-teal"
            ...
            <div className="flex items-center gap-2 xl:gap-3 2xl:gap-6 flex-shrink-0">
              ...
              <Link
                href="/schedule"
                className={`hidden lg:inline-flex min-[1380px]:hidden items-center gap-2 border-2 border-gray-900 text-gray-900 font-black uppercase tracking-wider hover:bg-gray-900 hover:text-white transition-all duration-200 active:scale-95 ${scrolled ? "px-3 py-2 text-xs" : "px-4 py-2.5 text-xs"
                  }`}
              >
              ...
              <button
                ...
                className="min-[1380px]:hidden w-11 h-11 flex items-center justify-center bg-gray-900 text-white hover:bg-brand-teal transition-colors"
