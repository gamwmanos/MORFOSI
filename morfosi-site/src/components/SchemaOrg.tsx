  ...
  const schema = {
    ...
    "@graph": [
      // ─── EducationalOrganization ───────────────────────────────────
      {
        ...
        description:
          "Κορυφαίο ιδιωτικό φροντιστήριο μέσης εκπαίδευσης στον Άγιο Δημήτριο. Ολιγομελή τμήματα Γυμνασίου & Λυκείου, εξειδικευμένη προετοιμασία Πανελλαδικών. 95%+ επιτυχία από το 2001.",
        telephone: phone,
        email,
        foundingDate: "2001",
        areaServed: {
