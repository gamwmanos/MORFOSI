...
export const metadata: Metadata = {
  ...
  description:
    'Ανακάλυψε το εξατομικευμένο πλάνο σπουδών για Γυμνάσιο, Λύκειο και ΕΠΑΛ. Μικρά τμήματα, εβδομαδιαία αξιολόγηση, 95% επιτυχία στις Πανελλήνιες. Κλείσε δωρεάν δοκιμαστικό μάθημα.',
  openGraph: {
